...
#imgurl <- "https://figshare.com/ndownloader/files/38964698"
#sticker(imgurl, package="", p_size=8, p_color = "#000000", p_family = "gochi", s_x=1, s_y=1, #s_width=.5, s_height=0.5, h_fill="#FFFFFF", h_color="#000000", filename="ecodata.5.png")
